...
{
    public partial class OPSchemeB123 : Form
    {
        //double sum, sumpy;
        ...
        void Calculation()
        {
            ...
            pav = IsNum(txtAC4) ? Convert.ToDouble(txtAC4.Text) : 0.00;
            ppv = IsNum(txtPY4) ? Convert.ToDouble(txtPY4.Text) : 0.00;
            pnp = IsNum(txtNP4) ? Convert.ToDouble(txtNP4.Text) : 0.00;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dt_temp = crud.ExecQuery("select CLAIM_SEQ_NO from user_claim_scheme where CLAIM_NUMBER='" + mainFrm.txtClaimNo.Text.ToUpper() + "' and SCHEME_DETAILS='btnOPB123'");
            ...
            try
            {
                ...
                "cl_gender", "cl_age", "cl_plan", "cl_loss_date", "cl_claim_number", "cl_create_date", "cl_remark", "cl_btn_details","cl_seq_no_temp","cl_daignosis" },
                              ...
                              mainFrm.txtAge.Text,
                               ...
                               txtRemarkSOld.Text,"btnOPB123","",txtDaignosis.Text  });
                ...
                for (int i = 1; i <= 2; i++)
                {
                    ...
                    DataTable dt_OP = crud.ExecSP_OutPara("SP_USER_OP_SCHEME_DETAILS",
                              ...
                              new string[] { a, OPDesctxt.Text.Replace(",", ""), OPtxt.Text.Replace(",", ""), dt.Rows[0][0].ToString(), DateTime.Now.ToShortDateString(), "" });
                }
                return true;
            }
            catch (Exception ex)
        ...
        private void OPSchemeB123_Load(object sender, EventArgs e)
        {
            ...
            "and SCHEME_DETAILS = 'btnOPB123' and CLAIM_NUMBER='" + mainFrm.txtClaimNo.Text.ToUpper() + "'");
            ...
            if (dt_load.Rows.Count > 0)
            {
                ...
                txtRemarkSOld.Text = dt_load.Rows[0]["REMARK"].ToString();
        ...
        private void btnGene_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OPSchemeB123_Load(sender, e);
                Reports.OPB123rp rpt = new Reports.OPB123rp();
        ...
        //private void txtRemarkSOld_KeyPress(object sender, KeyPressEventArgs e)
        //{
        //    enterkeytotab(e);
        //}
        #endregion
