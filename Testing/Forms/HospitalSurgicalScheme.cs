...
{
    public partial class HospitalSurgicalScheme : Form
    {
        CRUD crud = new CRUD();
        
        public bool abort = false, chck = false;

        public HospitalSurgicalScheme()
        {
            InitializeComponent();
        }
        ...
        {
            OPScheme frm = new OPScheme() { TopLevel = false, TopMost = true };
        ...
        {
            DetailsSchemeOld frm = new DetailsSchemeOld { TopLevel = false, TopMost = true };
            SetParent(frm.Handle, splitContainer1.Panel2.Handle);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txtClaimNo.Text.Substring(7, 3).ToUpper() != "HNS")
                {
                    Msgbox.Show("Transaction appear to have no content- Available only for product HNS");
                }
                else
                {
                   ...
                   DataTable dt = crud.ExecSP_OutPara("USER_HOPITAL_SCHEME_CHECK", Keys, Values);
                    ...
                    if (dt.Rows.Count != 0)
                    {
                        ...
                        {
                            float a = DateTime.Today.Year - Convert.ToInt32(dr["year"].ToString());
        ...
        {
            frmDocumentControl.disabledButt(btnDetailOld);
            frmDocumentControl.disabledButt(btnDetailsPlus);
            frmDocumentControl.disabledButt(btnOPB123);
            frmDocumentControl.disabledButt(btnOPScheme);
            frmDocumentControl.disabledButt(btnDetail2Plus);
        }
        public void en_button()
        {
            frmDocumentControl.enabledButt(btnDetailOld);
            frmDocumentControl.enabledButt(btnDetailsPlus);
            frmDocumentControl.enabledButt(btnOPB123);
            frmDocumentControl.enabledButt(btnOPScheme);
            frmDocumentControl.enabledButt(btnDetail2Plus);
        }
        ...
        private void HospitalSurgicalScheme_Load(object sender, EventArgs e)
        {
            dis_button();
        }
        ...
        private void txtClaimNo_Leave(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtClaimNo.Text.Length != 20)
                {
                    Msgbox.Show("Please input full Claim Number!");
                }

            }
        }

        private void btnDetailsPlus_Click(object sender, EventArgs e)
        {

            DetailedSchemePlus frm = new DetailedSchemePlus { TopLevel = false, TopMost = true };
            SetParent(frm.Handle, splitContainer1.Panel2.Handle);
            splitContainer1.Panel2.Controls.AddRange(new System.Windows.Forms.Control[] { frm });
            frm.Width = splitContainer1.Panel2.Width;
            //frm.Height = splitContainer1.Panel2.Height;
        ...
        private void btnDetail2Plus_Click(object sender, EventArgs e)
        {
            Details2SchemePlus frm = new Details2SchemePlus { TopLevel = false, TopMost = true };
            SetParent(frm.Handle, splitContainer1.Panel2.Handle);
            splitContainer1.Panel2.Controls.AddRange(new System.Windows.Forms.Control[] { frm });
            frm.Width = splitContainer1.Panel2.Width;
            //frm.Height = splitContainer1.Panel2.Height;
        ...
        private void btnOPScheme123_Click(object sender, EventArgs e)
        {
            OPSchemeB123 frm = new OPSchemeB123() { TopLevel = false, TopMost = true };
            SetParent(frm.Handle, splitContainer1.Panel2.Handle);
            splitContainer1.Panel2.Controls.AddRange(new System.Windows.Forms.Control[] { frm });
            frm.Width = splitContainer1.Panel2.Width;
            frm.Height = splitContainer1.Panel2.Height;
        ...
        private void btnOPB123_Click(object sender, EventArgs e)
        {
            OPSchemeB123 frm = new OPSchemeB123 { TopLevel = false, TopMost = true };
            SetParent(frm.Handle, splitContainer1.Panel2.Handle);
            frm.Width = splitContainer1.Panel2.Width;
