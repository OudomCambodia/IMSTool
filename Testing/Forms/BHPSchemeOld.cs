...
{
    public partial class BHPSchemeOld : Form
    {
        CRUD crud = new CRUD();
        ...
        void Calculation()
        {
            ...
            double PYSum = 0;
            double NPSum = 0;
            double TADue = 0, TPDue = 0, TANPDue = 0,TPYDue=0, pav = 0, ppv = 0, pnp = 0;
            for (int i = 1; i <= 36; i++)
            {
            ...
            pav = IsNum(txtAC36) ? Convert.ToDouble(txtAC36.Text) : 0.00;
            ppv = IsNum(txtPY36) ? Convert.ToDouble(txtPY36.Text) : 0.00;
            pnp = IsNum(txtNP36) ? Convert.ToDouble(txtNP36.Text) : 0.00;
            ...
            try
            {
                ...
                "cl_gender", "cl_age", "cl_plan", "cl_loss_date", "cl_claim_number", "cl_create_date", "cl_remark", "cl_btn_details","cl_seq_no_temp","cl_daignosis" },
                             ...
                             mainFrm.txtAge.Text,
                               ...
                               txtRemarkBHPOld.Text,"btnSchemeOld","",txtDaignosis.Text  });
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dt_temp = crud.ExecQuery("select CLAIM_SEQ_NO from user_claim_scheme where CLAIM_NUMBER='" + mainFrm.txtClaimNo.Text.ToUpper() + "' and SCHEME_DETAILS='btnSchemeOld'");
                if (dt_temp.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        if(call_sp_scheme("Claim_Insert")==true)
                        {
                            Cursor.Current = Cursors.WaitCursor;
                            Msgbox.Show("Updated!");
                        }
                        else { Msgbox.Show("Some input field are missing!"); }
        ...
        private void btnGenereateScheme_Click(object sender, EventArgs e)
        {
            try
            {
                Cursor.Current = Cursors.WaitCursor;
                ...
                BHPSchemeOld_Load(sender, e);
                Reports.BHPSchemeOld rpt = new Reports.BHPSchemeOld();
        ...
        private void BHPSchemeOld_Load(object sender, EventArgs e)
        {
            DataTable dt_load = crud.ExecQuery("select distinct t.*,CLAIM_NUMBER,SCHEME_DETAILS,CL_DAIGNOSIS,REMARK,INSURED_NAME,POLICY_NUMBER,regexp_replace(TO_CHAR(INCEPTION_DATE,'DD MONTH YYYY'),'\\s+', ' ') INCEPTION_DATE,regexp_replace(TO_CHAR(EXPIRY_DATE,'DD MONTH YYYY'),'\\s+', ' ') EXPIRY_DATE,PREMIUM_STATUS,MEMBER,MEMBER_STATUS,GENDER,to_CHAR(AGE) AGE,PLAN,regexp_replace(TO_CHAR(LOSS_DATE,'DD MONTH YYYY'),'\\s+', ' ') LOSS_DATE from ( " +
                  ...
                  "and SCHEME_DETAILS = 'btnSchemeOld' and CLAIM_NUMBER = '" + mainFrm.txtClaimNo.Text.ToUpper() + "'");

            if (dt_load.Rows.Count > 0)
            {
                txtDaignosis.Text = dt_load.Rows[0]["CL_DAIGNOSIS"].ToString();
                txtRemarkBHPOld.Text = dt_load.Rows[0]["REMARK"].ToString();
                dtv2 = dt_load.Copy();
        ...
        private void txtAC23_Leave(object sender, EventArgs e)
        {
            Calculation();
        }
        ...
        private void txtAC27_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY27_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC28_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY28_Leave(object sender, EventArgs e)
        {
            Calculation();

        }

        private void txtAC29_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY29_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC30_Leave(object sender, EventArgs e)
        {
            Calculation();

        }

        private void txtPY30_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC31_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY31_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC32_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY32_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC33_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY33_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC34_Leave(object sender, EventArgs e)
        {
            Calculation();

        }

        private void txtPY34_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC35_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY35_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtAC36_Leave(object sender, EventArgs e)
        {
            Calculation();
        }

        private void txtPY36_Leave(object sender, EventArgs e)
        {
            Calculation();
        }
        ...
        private void txtAC27_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC28_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);

        }

        private void txtAC29_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC30_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC31_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC32_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC33_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC34_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC35_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtAC36_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        //private void txtRemarkBHPOld_KeyPress(object sender, KeyPressEventArgs e)
        //{
        //    enterkeytotab(e);
        //}
        ...
        private void txtPY19_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }
        ...
        private void txtPY27_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY28_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY29_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY30_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY31_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY32_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY33_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);

        }

        private void txtPY34_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY35_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }

        private void txtPY36_KeyPress(object sender, KeyPressEventArgs e)
        {
            enterkeytotab(e);
        }
        #endregion
